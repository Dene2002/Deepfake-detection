...
def save_spectogram(file_name, label):
    ...
    filename = 'D:\\vit btech final year 2023\\Capstone\\whisper_code\\spectrograms_fast\\' + label + '\\' + file_name.replace(
        '.wav', '.png')
    plt.savefig(filename, dpi=400, bbox_inches='tight', pad_inches=0)
    plt.close('all')


text = pd.read_excel("D:\\vit btech final year 2023\\Capstone\\whisper_code\\sample_dataset_fast.xlsx")
print(text)
